...
/**
 * クイズの開始画面を表示するコンポーネント
 * Displays the start screen for a quiz, including the landmark name and a start button.
...
export default function StartScreen({ landmarkName }: StartScreenProps): React.JSX.Element {
  ...
  return (
    <div className="text-center">
      ...
      <p className="mt-2 text-lg text-gray-300">You are about to start a quiz for:</p>
